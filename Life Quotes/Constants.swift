...
var selectedUserDefaultFont = "selectedFont"

//MARK: - Font names and styles
var font: [FontStyles] = [
  FontStyles(fontName: "Cream Cake", fontStyle: UIFont(name: "Cream Cake", size: 17) ?? UIFont.systemFont(ofSize: 17), fontSelected: false),
